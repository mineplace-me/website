...
export const SocialButtons = component$(() => (
  <div class="flex flex-col lg:flex-row gap-2">
    ...
    <div class="flex flex-1 justify-evenly gap-1 mt-2 lg:mt-0">
      ...
      <a
        class="lum-btn rounded-lum-2 p-2 lum-bg-transparent"
    ...
    <>
      ...
      >
        <div class="flex-1 flex w-full lg:w-auto flex-col gap-2 items-start">
          ...
          >
            <img src={Mineplace} width={48} height={48} />
            <span class="text-2xl font-bold">
              Mineplace
              <span class="text-base flex items-center gap-1 font-normal">
                <Birdflop size={20} />
                Powered by Birdflop Hosting
              </span>
            </span>
                ...
                <>
                  <div class="flex flex-col gap-2">
                    {mapStore.players.map((player) => (
                      <button
                        key={player.uuid}
                        class="lum-btn flex-row items-center text-left p-4 gap-4 rounded-lum-2 cursor-pointer"
                        onClick$={() => {
                          mapRef.value?.contentWindow?.postMessage(
                            {
                  ...
                  <div class="flex flex-col gap-1">
                    {leaderboard.value?.data?.leaderboard.map(
                      (entry: LeaderboardEntry) => (
                        <div
                          key={entry.uuid}
                          class="lum-btn-p-2 lum-card flex-row rounded-lum-2 justify-between"
                        >
                ...
                const innerContent = (
                  <>
                    ...
                    <span class="flex-1">
                      ...
                      <span class="text-xs whitespace-pre-wrap">
                        {option.description}
                      </span>
                    </span>
                  </>
