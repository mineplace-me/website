...
export default component$(() => {
  return (
    <div class="flex flex-col items-center justify-center min-h-screen">
      <div class="animate-in fade-in slide-in-from-top-6 anim-duration-1000 lum-card p-16 shadow-xl backdrop-blur-md">
        ...
        <p class="text-4xl mb-6 font-minecraft">
        ...
        <div class="flex gap-2">
          <button class="lum-btn font-minecraft border-luminescent-500 border-2 hover:border-2 hover:lum-bg-luminescent-500 cursor-pointer">
            <Network size={24} />
